...
interactions = load_json_data('/Users/favourjames/Downloads/gsoc_llm/results/pmc6044858/sentence_output_direct.json')
...
with open('results/pmc6044858/grounded_genes', 'w') as file:
